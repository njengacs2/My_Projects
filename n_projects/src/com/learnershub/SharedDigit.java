...
/*Write a method named hasSharedDigit with two parameters of type int. 	
  ...
  //The method should return true if there is a digit that appears in both numbers, such as 2 
    in 12 and 23; otherwise, the method should return false.	
...
public class SharedDigit {
	...
	public static void main(String[] args) {
		...
		System.out.println(hasSharedDigit(8, 98));
